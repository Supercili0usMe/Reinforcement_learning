...
class RewardTracker:
    def __init__(self, writer, stop_reward, group_rewards: int = 1) -> None:
        self.writer = writer
...
def calc_loss(batch, net, tgt_net, gamma, device="cpu"):
    ...
    expected_state_actions_values = next_state_values.detach() * gamma + rewards_v
    return nn.MSELoss()(state_action_values, expected_state_actions_values)
